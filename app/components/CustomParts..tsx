    ...
    <div className="py-8">
      <div className="container mx-auto max-w-[1440px]">
        <div className="flex flex-col md:flex-row items-center bg-white shadow-lg overflow-hidden h-auto md:h-[403px]">
          ...
          {/* Text */}
          <div className="w-full md:w-1/2 h-[250px] md:h-[400px] p-4 md:p-8 flex flex-col justify-center bg-[#0487E2]">
            ...
            <p className="text-sm md:text-base mb-8 text-white font-light font-exo text-center md:text-left">
